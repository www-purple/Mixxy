...
public class ComicController {
	...
	/**
	 * Returns the {@link Result} containing the actual image data for a {@link Comic}. May be accessed through the
	 * {@code /api/} prefix for consistency, but the behavior for this case is identical, unlike that of the other routes.
	 * An image can be accessed with a plain old HTTP request, and will be returned to the client as its constituent bytes
	 * (as opposed to some encoding like base64).
	 *
